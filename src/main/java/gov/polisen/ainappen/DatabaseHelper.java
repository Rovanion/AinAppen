...
/**
 * This class is needed by ORMLite. It helps handle alot of useful things, one of them is
 * the creation of the database and creation of the tables.
 * @author Joakim
 *
 */
public class DatabaseHelper extends OrmLiteSqliteOpenHelper{
	...
	/*
	 * Create a "Dao"-object for each type of object you are about to store in your
	 * database. Also, create a RuntimeExceptionDao for each type of object you want
	 * to store in the database. The first argument for the Dao-object is the object Type
	 * (here, Case/Contact/etc). The second argument for the Dao is the "type" of the Primary Key
	 * used in the table for said Object-type. Getters for these also need implementation.
	 */
	...
	/**
	 * This is called when the database is first created, if you've added a new type of
	 * object you want to store in database, don't forget to create the new table for it
	 * in this method.
	 */
	@Override
