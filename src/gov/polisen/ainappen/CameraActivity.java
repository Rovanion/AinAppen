...
public class CameraActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fileUri = getOutputMediaFileUri(MEDIA_TYPE_IMAGE, selectedCaseId); // create a file to save the image
	...
	// If no case is specified (a photo just needs to be taken), null is returned. 
	...
	private static File getOutputMediaFile(int type, String caseID){
		...
		String timeStamp = new SimpleDateFormat("yyyyddMM-hhmmss", Locale.getDefault()).format(new Date());
		File mediaFile;
